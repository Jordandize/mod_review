...
/**
 * Review submission confirmation form
 *
 * @package   mod_review
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_review_confirm_submission_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('static', 'confirmmessage', '', get_string('confirmsubmission', 'mod_review'));
