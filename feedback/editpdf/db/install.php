 ...
 */
function xmldb_reviewfeedback_editpdf_install() {
    global $CFG;
    ...
    $filerecord->component = 'reviewfeedback_editpdf';
    ...
    foreach ($defaultstamps as $stamp) {
        ...
        $fs->create_file_from_pathname($filerecord,
            $CFG->dirroot . '/mod/review/feedback/editpdf/pix/' . $filerecord->filename);
    }
}
