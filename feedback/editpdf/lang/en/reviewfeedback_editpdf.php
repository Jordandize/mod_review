...
/**
 * Strings for component 'reviewfeedback_editpdf', language 'en'
 *
...
$string['default_help'] = 'If set, this feedback method will be enabled by default for all new reviews.';
...
$string['enabled_help'] = 'If enabled, the teacher will be able to create annotated PDF files when marking the reviews. This allows the teacher to add comments, drawing and stamps directly on top of the students work. The annotating is done in the browser and no extra software is required.';
