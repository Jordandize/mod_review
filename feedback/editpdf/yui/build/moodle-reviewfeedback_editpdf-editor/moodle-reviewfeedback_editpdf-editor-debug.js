YUI.add('moodle-reviewfeedback_editpdf-editor', function (Y, NAME) {
 ...
 */
var AJAXBASE = M.cfg.wwwroot + '/mod/review/feedback/editpdf/ajax.php',
    AJAXBASEPROGRESS = M.cfg.wwwroot + '/mod/review/feedback/editpdf/ajax_progress.php',
    CSS = {
        DIALOGUE: 'reviewfeedback_editpdf_widget'
    },
    SELECTOR = {
        ...
        SEARCHFILTER: '.reviewfeedback_editpdf_commentsearch input',
        SEARCHCOMMENTSLIST: '.reviewfeedback_editpdf_commentsearch ul',
        ...
        UNSAVEDCHANGESDIV: '.reviewfeedback_editpdf_warningmessages',
        UNSAVEDCHANGESINPUT: 'input[name="reviewfeedback_editpdf_haschanges"]',
...
var POINT = function(x, y) {
     ...
     * @method clip
     * @param M.reviewfeedback_editpdf.point
     * @public
     */
...
M.reviewfeedback_editpdf.point = POINT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.rect = RECT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var EDIT = function() {
     ...
     * @property start
     * @type M.reviewfeedback_editpdf.point|false
     * @public
     */
    this.start = false;
     ...
     * @property path
     * @type M.reviewfeedback_editpdf.point[]
     * @public
     */
    this.path = [];
};
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.edit = EDIT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 *
 * @namespace M.reviewfeedback_editpdf
 * @param M.reviewfeedback_editpdf.editor editor
 * @class drawable
 */
var DRAWABLE = function(editor) {

    /**
     * Reference to M.reviewfeedback_editpdf.editor.
     * @property editor
     * @type M.reviewfeedback_editpdf.editor
     * @public
     */
    this.editor = editor;
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.drawable = DRAWABLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATION, Y.Base, {
    ...
    /**
     * Reference to M.reviewfeedback_editpdf.drawable
     * @property drawable
     * @type M.reviewfeedback_editpdf.drawable
     * @public
     */
    drawable: false,
    ...
    draw_highlight: function() {
        ...
        if (this.editor.currentannotation === this) {
            ...
            var deleteicon = Y.Node.create('<img src="' + M.util.image_url('trash', 'reviewfeedback_editpdf') + '"/>'),
                deletelink = Y.Node.create('<a href="#" role="button"></a>');

            deleteicon.setAttrs({
                'alt': M.util.get_string('deleteannotation', 'reviewfeedback_editpdf')
            });
     ...
     * @public
     * @method draw
     * @return M.reviewfeedback_editpdf.drawable|false
     */
    draw: function() {
    ...
    init_from_edit: function(edit) {
        var bounds = new M.reviewfeedback_editpdf.rect();
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.annotation = ANNOTATION;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONLINE, M.reviewfeedback_editpdf.annotation, {
    /**
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.annotationline = ANNOTATIONLINE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONRECTANGLE, M.reviewfeedback_editpdf.annotation, {
    /**
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.annotationrectangle = ANNOTATIONRECTANGLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONPEN, M.reviewfeedback_editpdf.annotation, {
    /**
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.annotationpen = ANNOTATIONPEN;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONHIGHLIGHT, M.reviewfeedback_editpdf.annotation, {
    /**
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.annotationhighlight = ANNOTATIONHIGHLIGHT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONSTAMP, M.reviewfeedback_editpdf.annotation, {
    /**
    ...
    draw: function() {
        ...
        position = this.editor.get_window_coordinates(new M.reviewfeedback_editpdf.point(this.x, this.y));
    ...
    draw_current_edit: function(edit) {
        ...
        bounds.bound([edit.start, edit.end]);
        position = this.editor.get_window_coordinates(new M.reviewfeedback_editpdf.point(bounds.x, bounds.y));
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.annotationstamp = ANNOTATIONSTAMP;
...
Y.extend(DROPDOWN, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.addClass('reviewfeedback_editpdf_dropdown');
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.dropdown = DROPDOWN;
 ...
 * @class colourpicker
 * @constructor
 * @extends M.reviewfeedback_editpdf.dropdown
 */
COLOURPICKER = function(config) {
    COLOURPICKER.superclass.constructor.apply(this, [config]);
};

Y.extend(COLOURPICKER, M.reviewfeedback_editpdf.dropdown, {
     ...
     */
    initializer: function(config) {
        var colourlist = Y.Node.create('<ul role="menu" class="reviewfeedback_editpdf_menu"/>'),
            body;
        ...
        Y.each(this.get('colours'), function(rgb, colour) {
            ...
            title = M.util.get_string(colour, 'reviewfeedback_editpdf');
            iconname = this.get('iconprefix') + colour;
            img = M.util.image_url(iconname, 'reviewfeedback_editpdf');
        ...
        this.set('headerText', M.util.get_string('colourpicker', 'reviewfeedback_editpdf'));
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.colourpicker = COLOURPICKER;
...
Y.extend(STAMPPICKER, M.reviewfeedback_editpdf.dropdown, {
     ...
     */
    initializer: function(config) {
        var stamplist = Y.Node.create('<ul role="menu" class="reviewfeedback_editpdf_menu"/>');

        // Build a list of stamped buttons.
        Y.each(this.get('stamps'), function(stamp) {
            var button, listitem, title;

            title = M.util.get_string('stamp', 'reviewfeedback_editpdf');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('stamppicker', 'reviewfeedback_editpdf'));
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.stamppicker = STAMPPICKER;
...
Y.extend(COMMENTMENU, M.reviewfeedback_editpdf.dropdown, {
    ...
    initializer: function(config) {
        ...
        commentlinks = Y.Node.create('<ul role="menu" class="reviewfeedback_editpdf_menu"/>');

        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('addtoquicklist', 'reviewfeedback_editpdf') +
               '</a></li>');
        ...
        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('deletecomment', 'reviewfeedback_editpdf') +
               '</a></li>');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('commentcontextmenu', 'reviewfeedback_editpdf'));
        ...
        Y.each(comment.editor.quicklist.comments, function(quickcomment) {
            var listitem = Y.Node.create('<li class="quicklist_comment"></li>'),
                ...
                deletelinkitem = Y.Node.create('<a href="#" tabindex="-1" class="delete_quicklist_comment">' +
                                               ...
                                               'alt="' + M.util.get_string('deletecomment', 'reviewfeedback_editpdf') + '"/>' +
                                               '</a>');
    ...
    ATTRS: {
         ...
         *
         * @attribute comment
         * @type M.reviewfeedback_editpdf.comment
         * @default null
         */
        comment: {
            value: null
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.commentmenu = COMMENTMENU;
/* eslint-disable no-unused-vars */
/* global SELECTOR */
...
COMMENTSEARCH = function(config) {
    ...
    config.width = '400px';
    config.visible = false;
    config.headerContent = M.util.get_string('searchcomments', 'reviewfeedback_editpdf');
    config.footerContent = '';
...
Y.extend(COMMENTSEARCH, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb = this.get('boundingBox');
        bb.addClass('reviewfeedback_editpdf_commentsearch');

        editor = this.get('editor');
        container = Y.Node.create('<div/>');

        placeholder = M.util.get_string('filter', 'reviewfeedback_editpdf');
        commentfilter = Y.Node.create('<input type="text" size="20" placeholder="' + placeholder + '"/>');
        container.append(commentfilter);
        commentlist = Y.Node.create('<ul role="menu" class="reviewfeedback_editpdf_search"/>');
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.commentsearch = COMMENTSEARCH;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var COMMENT = function(editor, gradeid, pageno, x, y, width, colour, rawtext) {
     ...
     * @property menu
     * @type M.reviewfeedback_editpdf.dropdown
     * @public
     */
    this.menu = null;
        ...
        if (!this.editor.get('readonly')) {
            ...
            node.on('gesturemove', function(e) {
                if (editor.currentedit.tool === 'select') {
                    ...
                    newlocation = this.editor.get_canvas_coordinates(new M.reviewfeedback_editpdf.point(x, y));
            ...
            this.menu = new M.reviewfeedback_editpdf.commentmenu({
    ...
    this.updatePosition = function() {
        ...
        var newlocation = new M.reviewfeedback_editpdf.point(this.x, this.y);
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.comment = COMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.quickcomment = QUICKCOMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var QUICKCOMMENTLIST = function(editor) {
     ...
     * Array of Comments
     * @property shapes
     * @type M.reviewfeedback_editpdf.quickcomment[]
     * @public
     */
    this.comments = [];
    ...
    this.add = function(comment) {
        ...
        config = {
            ...
            data: {
                ...
                'reviewid': this.editor.get('reviewid')
            },
            on: {
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            quickcomment = new M.reviewfeedback_editpdf.quickcomment(jsondata.id,
                                                                                     jsondata.rawtext,
                                                                                     jsondata.width,
                                                                                     jsondata.colour);
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            Y.each(jsondata, function(comment) {
                                var quickcomment = new M.reviewfeedback_editpdf.quickcomment(comment.id,
                                                                                             comment.rawtext,
                                                                                             comment.width,
                                                                                             comment.colour);
                                this.comments.push(quickcomment);
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.quickcommentlist = QUICKCOMMENTLIST;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EDITOR.prototype = {
     ...
     * @type M.reviewfeedback_editpdf.edit
     * @protected
     */
    currentedit: new M.reviewfeedback_editpdf.edit(),

    /**
     * Current drawable.
     *
     * @property currentdrawable
     * @type M.reviewfeedback_editpdf.drawable|false
     * @protected
     */
     ...
     *
     * @property drawables
     * @type array(M.reviewfeedback_editpdf.drawable)
     * @protected
     */
    drawables: [],
     ...
     * @type M.reviewfeedback_editpdf.annotation
     * @protected
     */
     ...
     * @property quicklist
     * @type M.reviewfeedback_editpdf.quickcommentlist
     * @protected
     */
    quicklist: null,
    ...
    initializer: function() {
        ...
        if (link) {
            ...
            require(['mod_review/grading_review_panel'], function(ReviewPanelManager) {
                var panelManager = new ReviewPanelManager();

                var panel = panelManager.getReviewPanel('reviewfeedback_editpdf');
                if (panel) {
                    panel = Y.one(panel);
                    panel.empty();
                ...
                if (!this.get('readonly')) {
                    this.quicklist = new M.reviewfeedback_editpdf.quickcommentlist(this);
                }
            }.bind(this));
    ...
    refresh_button_state: function() {
        ...
        imgurl = M.util.image_url('background_colour_' + this.currentedit.commentcolour, 'reviewfeedback_editpdf');
        ...
        imgurl = M.util.image_url('colour_' + this.currentedit.annotationcolour, 'reviewfeedback_editpdf');
        button.one('img').setAttribute('src', imgurl);

        currenttoolnode = this.get_dialogue_element(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.addClass('reviewfeedback_editpdf_selectedbutton');
    ...
    get_canvas_bounds: function() {
        ...
        return new M.reviewfeedback_editpdf.rect(offsetleft, offsettop, width, height);
    },

    /**
     * Called to translate from window coordinates to canvas coordinates.
     * @method get_canvas_coordinates
     * @param M.reviewfeedback_editpdf.point point in window coordinats.
     */
    get_canvas_coordinates: function(point) {
        var bounds = this.get_canvas_bounds(),
            newpoint = new M.reviewfeedback_editpdf.point(point.x - bounds.x, point.y - bounds.y);
    ...
    warning: function(message, dismissable) {
        ...
        var messageclasses = 'reviewfeedback_editpdf_warningmessages alert alert-warning';
        if (dismissable) {
            delay = 4;
            messageclasses = 'reviewfeedback_editpdf_warningmessages alert alert-info';
        }
    ...
    prepare_pages_for_display: function(data) {
        ...
        if (!data.pagecount) {
            ...
            error = new M.core.alert({message: M.util.get_string('cannotopenpdf', 'reviewfeedback_editpdf')});
            error.show();
            return;
        }
        ...
        for (i = 0; i < this.pages.length; i++) {
            for (j = 0; j < this.pages[i].comments.length; j++) {
                ...
                this.pages[i].comments[j] = new M.reviewfeedback_editpdf.comment(this,
                                                                                 comment.gradeid,
                                                                                 comment.pageno,
                                                                                 comment.x,
                                                                                 comment.y,
        ...
        if (!readonly && data.partial) {
            ...
            this.warning(M.util.get_string('partialwarning', 'reviewfeedback_editpdf'), false);
        }
    ...
    handle_response_data: function(response) {
        ...
        try {
            ...
            if (data.error) {
                ...
                new M.core.alert({
                    message: M.util.get_string('cannotopenpdf', 'reviewfeedback_editpdf'),
                    visible: true
                });
            } else {
                return data;
            ...
            new M.core.alert({
                title: M.util.get_string('cannotopenpdf', 'reviewfeedback_editpdf'),
                visible: true
            });
        }
    ...
    setup_toolbar: function() {
        ...
        picker = new M.reviewfeedback_editpdf.colourpicker({
        ...
        if (stampfiles.length <= 0) {
            ...
            picker = new M.reviewfeedback_editpdf.stamppicker({
    ...
    handle_tool_button: function(e, tool) {
        ...
        currenttoolnode = this.get_dialogue_element(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.removeClass('reviewfeedback_editpdf_selectedbutton');
    ...
    get_current_drawable: function() {
        ...
        if (this.currentedit.tool === 'comment') {
            comment = new M.reviewfeedback_editpdf.comment(this);
    ...
    edit_move: function(e) {
        ...
        var bounds = this.get_canvas_bounds(),
            ...
            drawingregion = this.get_dialogue_element(SELECTOR.DRAWINGREGION),
            clientpoint = new M.reviewfeedback_editpdf.point(e.clientX + canvas.get('docScrollX'),
    ...
    create_annotation: function(type, data) {
        ...
        data.editor = this;
        if (type === "line") {
            return new M.reviewfeedback_editpdf.annotationline(data);
        } else if (type === "rectangle") {
            return new M.reviewfeedback_editpdf.annotationrectangle(data);
        } else if (type === "oval") {
            return new M.reviewfeedback_editpdf.annotationoval(data);
        } else if (type === "pen") {
            return new M.reviewfeedback_editpdf.annotationpen(data);
        } else if (type === "highlight") {
            return new M.reviewfeedback_editpdf.annotationhighlight(data);
        } else if (type === "stamp") {
            return new M.reviewfeedback_editpdf.annotationstamp(data);
        }
        return false;
    },
            ...
            on: {
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        this.warning(M.util.get_string('draftchangessaved', 'reviewfeedback_editpdf'), true);
                    } catch (e) {
                        return new M.core.exception(e);
                    }
                },
    ...
    open_search_comments: function(e) {
        if (!this.searchcommentswindow) {
            this.searchcommentswindow = new M.reviewfeedback_editpdf.commentsearch({
                editor: this
            });
        }
    ...
    setup_navigation: function() {
        ...
        if (options.size() <= 1) {
            for (i = 0; i < this.pages.length; i++) {
                ...
                option.setHTML(M.util.get_string('pagexofy', 'reviewfeedback_editpdf', strinfo));
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME: 'moodle-reviewfeedback_editpdf-editor',
    ATTRS: {
        userid: {
...
M.reviewfeedback_editpdf = M.reviewfeedback_editpdf || {};
M.reviewfeedback_editpdf.editor = M.reviewfeedback_editpdf.editor || {};
 ...
 * @param {Object} params
 */
M.reviewfeedback_editpdf.editor.init = M.reviewfeedback_editpdf.editor.init || function(params) {
    M.reviewfeedback_editpdf.instance = new EDITOR(params);
    return M.reviewfeedback_editpdf.instance;
};
