 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reviewfeedback_editpdf_widget implements renderable {

    /** @var int $review - Review instance id */
    public $review = 0;
    ...
    /**
     * Constructor
     * @param int $review - Review instance id
     ...
     */
    public function __construct($review, $userid, $attemptnumber, $downloadurl,
