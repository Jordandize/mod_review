@mod @mod_review @reviewfeedback @reviewfeedback_editpdf @_file_upload
Feature: In an review, teacher can annotate PDF files during grading
  ...
  Scenario: Submit a PDF file as a student and annotate the PDF as a teacher
    ...
    And I navigate to "Plugins > Activity modules > Review > Feedback plugins > Annotate PDF" in site administration
    ...
    And I upload "mod/review/feedback/editpdf/tests/fixtures/submission.pdf" file to "File submissions" filemanager
    And I upload "mod/review/feedback/editpdf/tests/fixtures/testgs.pdf" file to "File submissions" filemanager
