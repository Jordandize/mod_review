@mod @mod_review @reviewfeedback @reviewfeedback_comments
Feature: In an review, teachers can provide feedback comments on student submissions
  In order to provide feedback to students on their reviews
  As a teacher,
  ...
  Scenario: Teachers should be able to add and remove feedback comments via the quick grading interface
    Given the following "activities" exist:
      | activity | course | idnumber | name             | reviewsubmission_onlinetext_enabled | reviewfeedback_comments_enabled |
      | review   | C1     | review1  | Test review1 | 1                                   | 1                               |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test review1"
