...
/**
 * Post-install code for the reviewfeedback_file module.
 *
...
/**
 * Code run after the reviewfeedback_file module database tables have been created.
 * Moves the feedback file plugin down
 *
 * @return bool
 */
function xmldb_reviewfeedback_file_install() {
    global $CFG;
