 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_reviewfeedback_file_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_reviewfeedback_file_grade($data) {
        global $DB;
        ...
        $DB->insert_record('reviewfeedback_file', $data);

        $this->add_related_files('reviewfeedback_file', 'feedback_files', 'grade', null, $oldgradeid);
    }
