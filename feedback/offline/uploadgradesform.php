 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reviewfeedback_offline_upload_grades_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'uploadgrades', get_string('uploadgrades', 'reviewfeedback_offline'));
        ...
        $mform->addHelpButton('gradesfile', 'gradesfile', 'reviewfeedback_offline');
        ...
        $mform->addElement('checkbox', 'ignoremodified', '', get_string('ignoremodified', 'reviewfeedback_offline'));
        $mform->addHelpButton('ignoremodified', 'ignoremodified', 'reviewfeedback_offline');
        ...
        $this->add_action_buttons(true, get_string('uploadgrades', 'reviewfeedback_offline'));
