 ...
 *
 * @module     mod_review/grading_navigation_user_info
 * @package    mod_review
 * @class      UserInfo
...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates'], function($, notification, ajax, templates) {
     ...
     */
    UserInfo.prototype._getReviewId = function() {
        return this._region.attr('data-reviewid');
    };
    ...
    UserInfo.prototype._refreshUserInfo = function(event, userid) {
        ...
        templates.render('mod_review/loading', {}).done(function(html, js) {
            ...
            if (userid < 0) {
                // Render the template.
                templates.render('mod_review/grading_navigation_no_users', {}).done(function(html, js) {
            ...
            if (typeof this._userCache[userid] !== "undefined") {
                ...
                var reviewId = this._getReviewId();
                var requests = ajax.call([{
                    methodname: 'mod_review_get_participant',
                    args: {
                        userid: userid,
                        reviewid: reviewId,
                        embeduser: true
            ...
            promise.done(function(context) {
                ...
                templates.render('mod_review/grading_navigation_user_summary', context).done(function(html, js) {
                    // Update the page.
                    if (userid == this._lastUserId) {
                        this._region.fadeOut("fast", function() {
                            templates.replaceNodeContents(this._region, html, js);
