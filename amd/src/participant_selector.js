...
/**
 * Custom auto-complete adapter to load users from the review list_participants webservice.
 *
 * @module     mod_review/participants_selector
...
define(['core/ajax', 'jquery', 'core/templates'], function(ajax, $, templates) {
    ...
    return /** @alias module:mod_review/participants_selector */ {
        ...
        transport: function(selector, query, success, failure) {
            var reviewid = $(selector).attr('data-reviewid');
            ...
            ajax.call([{
                ...
                $.each(results, function(index, user) {
                    ...
                    if (show) {
                        ...
                        promises.push(templates.render('mod_review/list_participant_user_summary', ctx).then(function(html) {
