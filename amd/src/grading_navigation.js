 ...
 *
 * @module     mod_review/grading_navigation
 * @package    mod_review
...
define(['jquery', 'core/notification', 'core/str', 'core/form-autocomplete',
        'core/ajax', 'mod_review/grading_form_change_checker'],
    ...
    var GradingNavigation = function(selector) {
        ...
        str.get_string('changeuser', 'mod_review').done(function(s) {
                autocomplete.enhance('[data-action=change-user]', false, 'mod_review/participant_selector', s);
            }
    ...
    /**
     * Load the list of all users for this review.
     *
     * @private
    ...
    GradingNavigation.prototype._loadAllUsers = function() {
        ...
        var reviewid = select.attr('data-reviewid');
        ...
        ajax.call([{
            methodname: 'mod_review_list_participants',
            args: {reviewid: reviewid, groupid: groupid, filter: '', onlyids: true, tablesort: true},
    ...
    GradingNavigation.prototype._checkClickOutsideConfigureFilters = function(event) {
        ...
        if (!configPanel.is(event.target) && configPanel.has(event.target).length === 0) {
            ...
            $(document).unbind('click.mod_review_grading_navigation');
        }
    };
    ...
    GradingNavigation.prototype._filterChanged = function() {
        ...
        if (filterlist.length) {
            ...
            str.get_string('nofilters', 'mod_review').done(function(s) {
        ...
        var preferenceNames = ['review_filter', 'review_workflowfilter', 'review_markerfilter'];
    ...
    GradingNavigation.prototype._selectNoUser = function() {
        ...
        if (checker.checkFormForChanges('[data-region="grade-panel"] .gradeform')) {
            ...
            str.get_strings([
                {key: 'unsavedchanges', component: 'mod_review'},
                {key: 'unsavedchangesquestion', component: 'mod_review'},
                {key: 'saveandcontinue', component: 'mod_review'},
    ...
    GradingNavigation.prototype._toggleExpandFilters = function(event) {
        ...
        if (expanded) {
            ...
            $(document).on('click.mod_review_grading_navigation', this._checkClickOutsideConfigureFilters.bind(this));
        }
    };
    ...
    GradingNavigation.prototype._setCountString = function(x, y) {
        ...
        var param = {x: x, y: y};
        str.get_string('xofy', 'mod_review', param).done(function(s) {
