...
require_once($CFG->dirroot.'/mod/review/reviewplugin.php');

/**
 * Abstract class for feedback_plugin inherited from review_plugin abstract class.
 *
 * @package   mod_review
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class review_feedback_plugin extends review_plugin {
     ...
     *      'component' => REVIEWFEEDBACK_XYZ_COMPONENT,
     *      'filearea' => REVIEWFEEDBACK_XYZ_FILEAREA,
     *      'itemid' => $grade->id
     * ]
     *
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole review.
     * @return array - An array of action and description strings.
