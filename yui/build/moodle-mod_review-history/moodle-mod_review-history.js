YUI.add('moodle-mod_review-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-review-history-link',
        OPEN: 'mod-review-history-link-open',
        CLOSED: 'mod-review-history-link-closed',
        PANEL: 'mod-review-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
