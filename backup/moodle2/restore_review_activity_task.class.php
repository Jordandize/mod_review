...
/**
 * review restore task that provides all the settings and steps to perform one complete restore of the activity
 *
 * @package   mod_review
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class restore_review_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // Review only has one structure step.
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('REVIEWVIEWBYID',
                                           '/mod/review/view.php?id=$1',
                                           'course_module');
        $rules[] = new restore_decode_rule('REVIEWINDEX',
                                           '/mod/review/index.php?id=$1',
                                           'course_module');
