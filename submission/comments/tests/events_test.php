 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reviewsubmission_comments_events_testcase extends advanced_testcase {
    ...
    public function test_comment_created() {
        ...
        $this->assertInstanceOf('\reviewsubmission_comments\event\comment_created', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new moodle_url('/mod/review/view.php', array('id' => $review->get_course_module()->id));
    ...
    public function test_comment_deleted() {
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\reviewsubmission_comments\event\comment_deleted', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new moodle_url('/mod/review/view.php', array('id' => $review->get_course_module()->id));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
