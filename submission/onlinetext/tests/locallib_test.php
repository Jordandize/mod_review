...
/**
 * Tests for mod/review/submission/onlinetext/locallib.php
 *
...
/**
 * Unit tests for mod/review/submission/onlinetext/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reviewsubmission_onlinetext_locallib_testcase extends advanced_testcase {
    ...
    public function test_new_submission_empty($submissiontext, $expected) {
        ...
        $result = $review->new_submission_empty((object) [
                'onlinetext_editor' => [
                    'text' => $submissiontext,
                ],
            ]);
