...
class reviewsubmission_onlinetext_events_testcase extends advanced_testcase {
    ...
    public function test_assessable_uploaded() {
        ...
        $event = reset($events);
        $this->assertInstanceOf('\reviewsubmission_onlinetext\event\assessable_uploaded', $event);
    ...
    public function test_submission_created() {
        ...
        $this->assertCount(2, $events);
        $event = $events[1];
        $this->assertInstanceOf('\reviewsubmission_onlinetext\event\submission_created', $event);
        $this->assertEquals($context->id, $event->contextid);
    ...
    public function test_submission_updated() {
        ...
        $this->assertCount(2, $events);
        $event = $events[1];
        $this->assertInstanceOf('\reviewsubmission_onlinetext\event\submission_updated', $event);
        $this->assertEquals($context->id, $event->contextid);
        $this->assertEquals($course->id, $event->courseid);
        $this->assertEquals($submission->id, $event->other['submissionid']);
        $this->assertEquals($submission->attemptnumber, $event->other['submissionattempt']);
