...
/**
 * The reviewsubmission_onlinetext assessable uploaded event.
 *
...
/**
 * The reviewsubmission_onlinetext assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has saved an online text submission with id '$this->objectid' " .
            "in the review activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'reviewsubmission_onlinetext');
    }
