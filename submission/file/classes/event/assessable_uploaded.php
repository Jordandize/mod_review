...
/**
 * The reviewsubmission_file assessable uploaded event.
 *
...
/**
 * The reviewsubmission_file assessable uploaded event class.
 *
 * @package    reviewsubmission_file
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'reviewsubmission_file');
    }
