...
/**
 * Tests for mod/review/submission/file/locallib.php
 *
...
/**
 * Unit tests for mod/review/submission/file/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reviewsubmission_file_locallib_testcase extends advanced_testcase {
    ...
    public function test_new_submission_empty_directory_only() {
        ...
        $this->assertTrue($review->new_submission_empty($submission));
    }
