@mod @mod_review @reviewsubmission_file
Feature: In an review, limit submittable file types
  ...
  Background:
    ...
    And the following config values are set as admin:
      | filetypes | image/png;spreadsheet | reviewsubmission_file |

  @javascript
  Scenario: File types validation for an review
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | reviewsubmission_file_maxfiles | reviewsubmission_file_maxsizebytes |
      | review   | C1     | review1  | Test review name | Test review description | 1388534400 | 0                                   | 1                             | 1                              | 0                                  |
  ...
  Scenario: Uploading permitted file types for an review
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | reviewsubmission_file_maxfiles | reviewsubmission_file_maxsizebytes | reviewsubmission_file_filetypes |
      | review   | C1     | review1  | Test review name | Test review description | 1388534400 | 0                                   | 1                             | 3                              | 0                                  | image/png,spreadsheet,.xml,.txt  |
  ...
  Scenario: No filetypes allows all
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | reviewsubmission_file_maxfiles | reviewsubmission_file_maxsizebytes | reviewsubmission_file_filetypes |
      | review   | C1     | review1  | Test review name | Test review description | 1388534400 | 0                                   | 1                             | 2                              | 0                                  |                                 |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    When I press "Add submission"
