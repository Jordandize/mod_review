...
/**
 * Strings for component 'reviewsubmission_file', language 'en'
 *
...
$string['default_help'] = 'If set, this submission method will be enabled by default for all new reviews.';
...
$string['maxfiles_help'] = 'If file submissions are enabled, each review can be set to accept up to this number of files for their submission.';
...
$string['privacy:metadata:filepurpose'] = 'The files loaded for this review submission';
