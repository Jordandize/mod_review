 ...
 * needed to restore one review_submission subplugin.
 *
 * @package reviewsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_reviewsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_reviewsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('reviewsubmission_file', $data);

        $this->add_related_files('reviewsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
