...
Feature: Grant an extension to an offline student
  ...
  @javascript
  Scenario: Granting an extension to an offline review
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | duedate    |
      | review   | C1     | review1  | Test review name | Test review description | 0                                   | 0                             | 1388534400 |
  ...
  @javascript @_alert
  Scenario: Granting extensions to an offline review (batch action)
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | duedate    |
      | review   | C1     | review1  | Test review name | Test review description | 0                                   | 0                             | 1388534400 |
    And I log in as "teacher1"
  ...
  Scenario: Validating that extension date is after due date
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | allowsubmissionsfromdate    | duedate    |
      | review   | C1     | review1  | Test review name | Test review description | 0                                   | 0                             | 1388534400                  | 1388620800 |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    When I navigate to "View all submissions" in current page administration
