@mod @mod_review
Feature: Submit review without group
  As a teacher
  I should be able to prevent students submitting team reviews as members of the default group
  ...
  Scenario: Switch between group modes
    ...
    And the following "activities" exist:
      | activity | course | idnumber | name                     | intro                       | reviewsubmission_onlinetext_enabled | preventsubmissionnotingroup | teamsubmission |
      | review   | C1     | review1  | Allow default group      | Test review description | 1                                   | 0                           | 1              |
      | review   | C1     | review2  | Require group membership | Test review description | 1                                   | 1                           | 1              |
      | review   | C2     | review2  | Require group membership | Test review description | 1                                   | 1                           | 1              |
      | review   | C3     | review2  | Require group membership | Test review description | 1                                   | 1                           | 1              |
    ...
    And the following "group members" exist:
      ...
      | student3 | GC31  |
      | student3 | GC32  |
    # Student 1 can only submit review in course 2.
    When I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Allow default group"
    Then I should not see "Not a member of any group"
    And I should not see "This review requires submission in groups. You are not a member of any group"
    And I should see "Nothing has been submitted for this review"
    ...
    And I should see "This review requires submission in groups. You are not a member of any group"
    And I should see "Nothing has been submitted for this review"
    ...
    And I should see "Submitted for grading"
    And I log out
    # Teacher should see student 1 and student 2 has submitted review.
    ...
    And I should see "The review requires submission in groups. You are a member of more than one group."
    And I should see "Nothing has been submitted for this review"
    And I should not see "Add submission"
    And I log out
    And I log in as "teacher1"
