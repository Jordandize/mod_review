@mod @mod_review
Feature: Review with no calendar capabilites
  In order to allow work effectively
  As a teacher
  I need to be able to create reviews even when I cannot edit calendar events
  ...
  Scenario: Editing an review
    Given I log in as "admin"
    And I am on "Course 1" course homepage with editing mode on
    When I add a "Review" to section "1" and I fill the form with:
    ...
    Then I should see "Test review name"
