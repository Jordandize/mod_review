...
Feature: In an review, students can comment in their submissions
  In order to refine review submissions
  As a student
  ...
  Scenario: Student comments an review submission
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | reviewsubmission_onlinetext_enabled |
      | review   | C1     | review1  | Test review name | Test review description | 1 |
  ...
  Scenario: Teacher can comment on an offline review
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | reviewfeedback_comments_enabled |
      | review   | C1     | review1  | Test review name | Test review description | 0 | 0 | 1 |
  ...
  Scenario: Teacher can comment on reviews with a zero grade
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | reviewsubmission_onlinetext_enabled | reviewsubmission_file_enabled | reviewfeedback_comments_enabled |
      | review   | C1     | review1  | Test review name | Test review description | 0 | 0 | 1 |
    And I log in as "teacher1"
