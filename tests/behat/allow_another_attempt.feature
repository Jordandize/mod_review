@mod @mod_review
Feature: In an review, students start a new attempt based on their previous one
  In order to improve my submission
  As a student
  I need to submit my review editing an online form, receive feedback, and then improve my submission.
