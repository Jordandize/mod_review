@mod @mod_review
Feature: Review group override
  In order to grant a group special access to an review
  As a teacher
  ...
  Background:
    ...
    And I add a "Review" to section "1" and I fill the form with:
      ...
      | reviewsubmission_onlinetext_wordlimit_enabled | 1 |
      | reviewsubmission_onlinetext_wordlimit | 10 |
      | reviewsubmission_file_enabled | 0 |
      | gradingduedate[enabled]       | 0 |

  Scenario: Add, modify then delete a group override
    When I follow "Test review name"
  ...
  Scenario: Allow a group to have a different start date
    ...
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    Then I should see "This review will accept submissions from Wednesday, 1 January 2020, 8:00"
    And I should not see "Add submission"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    And I should not see "This review will accept submissions from Wednesday, 1 January 2020, 8:00"
  ...
  Scenario: Add both a user and group override and verify that both are applied correctly
    ...
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    And I should see "This review will accept submissions from Friday, 1 January 2021, 8:00"
    And I log out
    And I log in as "student2"
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    And I should see "This review will accept submissions from Tuesday, 1 January 2030, 8:00"
    And I log out
    And I log in as "student3"
    And I am on "Course 1" course homepage
    And I follow "Test review name"
    And I should see "This review will accept submissions from Wednesday, 1 January 2020, 8:00"
