 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_review_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the reviews */
    ...
    /**
     * Setup function - we will create a course and add an review instance to it.
     */
    ...
    protected function create_instance($params=array()) {
        ...
        return new mod_review_testable_review($context, $cm, $this->course);
    }
...
class_alias('mod_review_testable_review', 'testable_review');
