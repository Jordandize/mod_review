...
require_once($CFG->dirroot . '/mod/review/feedback/comments/locallib.php');

/**
 * Unit tests for the review feedback subplugins API's privacy legacy_polyfill.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_reviewfeedback_privacy_legacy_polyfill_test extends advanced_testcase {
    ...
    public function test_get_context_for_userid_within_feedback() {
        ...
        $mock = $this->createMock(test_reviewfeedback_legacy_polyfill_mock_wrapper::class);
    ...
    public function test_export_feedback_user_data() {
        ...
        $subplugin = new review_feedback_comments($review, 'comments');
...
/**
 * Legacy polyfill test class for the reviewfeedback_provider.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_legacy_polyfill_feedback_provider implements \mod_review\privacy\reviewfeedback_provider {
    use \mod_review\privacy\feedback_legacy_polyfill;
    /**
    ...
    /**
     * Returns student user ids related to the provided teacher ID. If an entry must be present in the review_grade table for
     ...
     */
    public static function _export_feedback_user_data(\mod_review\privacy\review_plugin_request_data $exportdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_feedback_for_context(\mod_review\privacy\review_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_feedback_for_grade(\mod_review\privacy\review_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
}
/**
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_reviewfeedback_legacy_polyfill_mock_wrapper {
    /**
