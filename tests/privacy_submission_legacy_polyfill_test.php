...
/**
 * Unit tests for the privacy legacy polyfill for mod_review.
 *
 * @package     mod_review
 * @category    test
...
require_once($CFG->dirroot . '/mod/review/submission/comments/locallib.php');

/**
 * Unit tests for the review submission subplugins API's privacy legacy_polyfill.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_reviewsubmission_privacy_legacy_polyfill_test extends advanced_testcase {
    ...
    public function test_get_context_for_userid_within_submission() {
        ...
        $mock = $this->createMock(test_reviewsubmission_legacy_polyfill_mock_wrapper::class);
    ...
    public function test_get_student_user_ids() {
        $teacherid = 107;
        $reviewid = 15;
        $useridlist = new \mod_review\privacy\useridlist($teacherid, $reviewid);
        $mock = $this->createMock(test_reviewsubmission_legacy_polyfill_mock_wrapper::class);
        $mock->expects($this->once())
            ->method('get_return_value')
    ...
    public function test_export_submission_user_data() {
        ...
        $subplugin = new review_submission_comments($review, 'comment');
...
/**
 * Legacy polyfill test class for the reviewsubmission_provider.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_legacy_polyfill_submission_provider implements \mod_review\privacy\reviewsubmission_provider {
    use \mod_review\privacy\submission_legacy_polyfill;
    /**
     ...
     * NOTE if your subplugin must have an entry in the review_grade table to work, then this
     * method can be empty.
     *
     ...
     * the sql query in \mod_review\privacy\provider::find_grader_info() Then you need to provide some sql to retrive those
     ...
     */
    public static function _get_student_user_ids(\mod_review\privacy\useridlist $useridlist) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }

    /**
     * This method is used to export any user data this sub-plugin has using the review_plugin_request_data object to get the
     * context and userid.
     ...
     * - user object
     *
     * @param  review_plugin_request_data $exportdata Contains data to help export the user information.
     */
    public static function _export_submission_user_data(\mod_review\privacy\review_plugin_request_data $exportdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_submission_for_context(\mod_review\privacy\review_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_submission_for_userid(\mod_review\privacy\review_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
}
/**
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_reviewsubmission_legacy_polyfill_mock_wrapper {
    /**
