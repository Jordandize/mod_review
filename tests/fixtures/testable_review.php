 ...
 */
class mod_review_testable_review extends review {
    ...
    public function testable_process_set_batch_marking_allocation($selectedusers, $markerid) {
        ...
        mod_review_batch_set_allocatedmarker_form::mock_submit($data);
    ...
    public function testable_process_set_batch_marking_workflow_state($selectedusers, $state) {
        ...
        mod_review_batch_set_marking_workflow_state_form::mock_submit($data);
    ...
    public function testable_view_batch_set_workflow_state($selectedusers) {
        global $PAGE;
        $PAGE->set_url('/mod/review/view.php');
    ...
    public function testable_grading_batch_operations_form($operation, $selectedusers) {
        ...
        mod_review_grading_batch_operations_form::mock_submit($data);

        // Set required variables in the form.
        $formparams = array();
        $formparams['submissiondrafts'] = 1;
        $formparams['duedate'] = 1;
        $formparams['attemptreopenmethod'] = REVIEW_ATTEMPT_REOPEN_METHOD_MANUAL;
        ...
        $mform = new mod_review_grading_batch_operations_form(null, $formparams);
