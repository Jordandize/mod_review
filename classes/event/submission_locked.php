...
/**
 * The mod_review submission locked event.
 *
 * @package    mod_review
...
/**
 * The mod_review submission locked event class.
 *
 * @package    mod_review
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' locked the submission for the user with id '$this->relateduserid' for " .
            "the review with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'review', array('id' => $user->id, 'fullname' => fullname($user)));
