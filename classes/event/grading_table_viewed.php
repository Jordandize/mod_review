...
/**
 * The mod_review grading table viewed event.
 *
 * @package    mod_review
...
/**
 * The mod_review grading table viewed event class.
 *
...
class grading_table_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingtableviewed', 'mod_review');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the grading table for the review with course module " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissiongradingtable', 'review');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call grading_table_viewed::create() directly, use grading_table_viewed::create_from_review() instead.');
        }
