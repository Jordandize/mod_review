...
/**
 * The mod_review submission graded event.
 *
 * @package    mod_review
...
/**
 * The mod_review submission graded event class.
 *
 * @package    mod_review
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_graded extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has graded the submission '$this->objectid' for the user with " .
            "id '$this->relateduserid' for the review with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('review_grades', $this->objectid);
        $this->set_legacy_logdata('grade submission', $this->review->format_grade_for_log($grade));
