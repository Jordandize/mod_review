...
/**
 * The mod_review review batch set workflow stated viewed event.
 *
 * @package    mod_review
...
class batch_set_workflow_state_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetworkflowstateviewed', 'mod_review');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the batch set workflow for the review with course " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchsetmarkingworkflowstate', 'review');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call batch_set_workflow_state_viewed::create() directly, use batch_set_workflow_state_viewed::create_from_review() instead.');
        }
