...
/**
 * The mod_review statement accepted event.
 *
 * @package    mod_review
...
/**
 * The mod_review statement accepted event class.
 *
 * @package    mod_review
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class statement_accepted extends base {
    ...
    public static function get_name() {
        return get_string('eventstatementaccepted', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        global $USER;
        $logmessage = get_string('submissionstatementacceptedlog', 'mod_review', fullname($USER)); // Nasty hack.
