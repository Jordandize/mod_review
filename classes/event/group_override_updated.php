...
/**
 * The mod_review group override updated event.
 *
 * @package    mod_review
...
/**
 * The mod_review group override updated event class.
 *
...
class group_override_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverrideupdated', 'mod_review');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the override with id '$this->objectid' for the review with " .
