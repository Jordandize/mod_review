...
/**
 * The mod_review submission unlocked event.
 *
 * @package    mod_review
...
/**
 * The mod_review submission unlocked event class.
 *
 * @package    mod_review
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_unlocked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionunlocked', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('unlocksubmissionforstudent', 'review', array('id' => $user->id, 'fullname' => fullname($user)));
