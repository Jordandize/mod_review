...
/**
 * The mod_review grading form viewed event.
 *
 * @package    mod_review
...
/**
 * The mod_review grading form viewed event class.
 *
...
class grading_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingformviewed', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $msg = get_string('viewgradingformforstudent', 'review',
