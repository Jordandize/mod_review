...
class submission_confirmation_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionconfirmationformviewed', 'mod_review');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the submission confirmation form for the review with " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewownsubmissionform', 'review');
        $this->set_legacy_logdata('view confirm submit review form', $logmessage);
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_confirmation_form_viewed::create() directly, use submission_confirmation_form_viewed::create_from_review() instead.');
        }
