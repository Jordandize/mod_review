...
/**
 * The mod_review submission_created abstract event.
 *
 * @package    mod_review
...
/**
 * The mod_review submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_review');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'review_submission', 'restore' => 'submission');
