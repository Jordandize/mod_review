...
/**
 * The mod_review reveal identities confirmation page viewed event.
 *
 * @package    mod_review
...
/**
 * The mod_review reveal identities confirmation page viewed event class.
 *
...
class reveal_identities_confirmation_page_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventrevealidentitiesconfirmationpageviewed', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewrevealidentitiesconfirm', 'review'));
