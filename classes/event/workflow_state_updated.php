...
/**
 * mod_review workflow state updated event.
 *
 * @package    mod_review
...
/**
 * mod_review workflow state updated event class.
 *
...
class workflow_state_updated extends base {
     ...
     */
    public static function create_from_user(\review $review, \stdClass $user, $state) {
        $data = array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' has set the workflow state of the user with id '$this->relateduserid' " .
            "to the state '{$this->other['newstate']}' for the review with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventworkflowstateupdated', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkingworkflowstateforlog', 'review', $a);
