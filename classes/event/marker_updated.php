...
/**
 * The mod_review marker updated event.
 *
 * @package    mod_review
...
/**
 * The mod_review marker updated event class.
 *
...
class marker_updated extends base {
     ...
     */
    public static function create_from_marker(\review $review, \stdClass $user, \stdClass $marker) {
        $data = array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' has set the marker for the user with id '$this->relateduserid' to " .
            "'{$this->other['markerid']}' for the review with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventmarkerupdated', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkerallocationforlog', 'review', $a);
