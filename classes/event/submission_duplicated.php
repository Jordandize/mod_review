...
/**
 * The mod_review submission duplicated event.
 *
 * @package    mod_review
...
/**
 * The mod_review submission duplicated event class.
 *
 * @package    mod_review
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_duplicated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionduplicated', 'mod_review');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submissioncopied', $this->review->format_submission_for_log($submission));
